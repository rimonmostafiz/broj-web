            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"
                          action="{{ url('/c/'.$contest->contest_id.'/problem-add') }}">
                    {{ csrf_field() }}

                    <!-- Problem Name -->
                        <div class="form-group{{ $errors->has('problem_name') ? ' has-error' : '' }}">
                            <label for="problem_name" class="col-md-2 control-label">Problem Title</label>

                            <div class="col-md-10">
                                <input id="problem_name" type="text" class="form-control"
                                       name="problem_name" value="{{ old('problem_name') }}">
                        ...
                        <div class="form-group{{ $errors->has('problem_author') ? ' has-error' : '' }}">
                            <label for="problem_author" class="col-md-2 control-label">Problem Author</label>

                            <div class="col-md-10">
                                <input id="problem_author" type="name" class="form-control"
                                       name="problem_author" value="{{ old('problem_author') }}">
                        ...
                        <div class="form-group{{ $errors->has('statement') ? ' has-error' : '' }}">
                            <label for="statement" class="col-md-2 control-label">Statement</label>

                            <div class="col-md-10">
                                <textarea rows="10" cols="80" id="statement" type="text" class="form-control"
                                          name="statement" value="{{ old('statement') }}"></textarea>
                        ...
                        <div class="form-group{{ $errors->has('sample_input') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea id="sample_input" type="text" class="form-control"
                                          name="sample_input" value="{{ old('sample_input') }}"></textarea>
                        ...
                        <div class="form-group{{ $errors->has('sample_output') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-10">
                                <textarea id="sample_output" type="text" class="form-control"
                                          name="sample_output" value="{{ old('sample_output') }}"></textarea>
                        ...
                        <div class="form-group{{ $errors->has('time_limit') ? ' has-error' : '' }}">
                            <label for="time_limit" class="col-md-2 control-label">Time Limit (sec)</label>

                            <div class="col-md-10">
                                <input id="time_limit" type="text" class="form-control"
                                       name="time_limit" value="{{ old('time_limit') }}">
                        ...
                        <div class="form-group{{ $errors->has('memory_limit') ? ' has-error' : '' }}">
                            <label for="memory_limit" class="col-md-2 control-label">Memory Limit (bytes)</label>

                            <div class="col-md-10">
                                <input id="memory_limit" type="text" class="form-control"
                                       name="memory_limit" value="{{ old('memory_limit') }}">
                        ...
                        <div class="form-group{{ $errors->has('score') ? ' has-error' : '' }}">
                            <label for="score" class="col-md-2 control-label">Score/Point</label>
                        ...
                        <div class="form-group{{ $errors->has('judge_input') ? ' has-error' : '' }}">
                            <label for="judge_input" class="col-md-2 control-label">Judge Input(File)</label>
                        ...
                        <div class="form-group{{ $errors->has('judge_output') ? ' has-error' : '' }}">
                            <label for="judge_output" class="col-md-2 control-label">Judge Output(File)</label>
